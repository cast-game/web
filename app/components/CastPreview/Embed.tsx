...
// import type { EmbeddedCast } from "@neynar/nodejs-sdk/build/neynar-api/v2";
...
//   }
// }
// export async function Embed({ _embedObject }: { _embedObject: EmbeddedCast }) {
//   const embedObject = _embedObject as any;
//   if (embedObject.url) {
...
//             </div>
//             <p className="pb-2">
//               {cast.content.replace(/https?:\/\/\S+/i, "")}
//             </p>
//           </div>
//         </div>
//       </Link>
